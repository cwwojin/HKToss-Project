...
from inference_api.utils import ApiKeyGuard, parse_boolean
...
def get_inference_result(
    ...
    model_name: str = None,
    force_reload: str = None,
    api_key: APIKey = Depends(ApiKeyGuard),
) -> List[InferenceResult]:
    """Run model inference."""
    return inferenceService.get_inference_results(
        inferenceDto, model_name, parse_boolean(force_reload)
    )
